...
###Cross-Validation
We will perform cross-validation by patitioning our training data set into 2 subsamples: subTraining data (70% of the original Training data set) and subTesting data (30% of the original Testing data set).
